...
int insertar_en_arbol_bin_busq(t_arbol* pa, const t_info* pd, t_cmp comparar); ///Retorna TODO_OK, DUPLICADO O SIN_MEM
...
//void enlistarAsc(t_info * pinfo, void * datos_accion);
